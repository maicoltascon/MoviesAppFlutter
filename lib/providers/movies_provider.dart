...
class MoviesProvider extends ChangeNotifier {
  ...
  final StreamController<List<Movie>> _suggestionsStrteamController = StreamController.broadcast();
  Stream<List<Movie>> get suggestionStream => _suggestionsStrteamController.stream;
  ...
  void getSuggestionsByQuery(String query) {
    ...
    debouncer.onValue = (value) async {
      ...
      _suggestionsStrteamController.add(results);
    };
